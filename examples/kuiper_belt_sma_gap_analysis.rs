...
//! ## Run with:
//! ```bash
//! cargo run --example kuiper_belt_sma_gap_analysis --features storage
//! ```

mod kuiper_belt;

use kuiper_belt::kbo_data::get_kbo_data;
...
fn analyze_sma_gaps(objects: &[kuiper_belt::kuiper_cluster::KuiperBeltObject]) -> SMAGapAnalysisResult {
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("📥 Loading KBO data from NASA/JPL SBDB...\n");
