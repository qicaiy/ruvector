...
// RLM (Ruvector Language Model) exports
pub use rlm::{
    AggregationStrategy,
    AnswerId,
    // Synthesizer types
    ...
    EnvironmentConfig,
    EnvironmentType,
    FinishReason as RlmFinishReason,
    GenerationOutput as RlmGenerationOutput,
    GenerationParams as RlmGenerationParams,
    KvCache as RlmKvCache,
    KvCacheEntry as RlmKvCacheEntry,
    KvCacheStats as RlmKvCacheStats,
    // Trait types
    LlmBackendTrait,
    MemoryConfig as RlmMemoryConfig,
    MemoryEntry as RlmMemoryEntry,
    // Type module types
    MemoryId,
    MemoryMetadata as RlmMemoryEntryMetadata,
    MemorySearchResult as RlmMemorySearchResult,
    MemorySpan,
    MemoryStore as RlmMemoryStore,
    MemoryStoreEntry,
    MemoryStoreMetadata,
    NativeEnvironment,
    Query,
    ...
    QueryResult,
    QueryType,
    // Recursive config (advanced settings)
    RecursiveConfig,
    RecursiveConfigBuilder,
    RlmAnswer,
    // Controller config (primary API)
    RlmConfig,
    // Controller types
    RlmController,
    // Environment types
    ...
    SubQuery,
    SynthesisResult,
    TokenUsage as RlmTokenUsage,
    TraitsDecompositionStrategy,
    TraitsFinishReason,
    TraitsGenerationOutput,
    TraitsGenerationParams,
    TraitsMemoryMetadata,
    TraitsMemorySpan,
    TraitsQueryContext,
    TraitsQueryDecomposition,
    TraitsRlmAnswer,
    TraitsSubAnswer,
    TraitsSubQuery,
    TraitsTokenUsage,
...
// WASM RLM exports (wasm32 only with rlm-wasm feature)
#[cfg(all(target_arch = "wasm32", feature = "rlm-wasm"))]
pub use rlm::{WasmEnvironment, WasmRlmController};
